...
if (!ema3 || !atr || ema3 === 0 || atr === 0) {
    console.log("[WARN] ema3 ou ATR non disponible – cycle ignoré.");
    return;
}
...
// Seuils d'entrée
const longEntryThreshold  = ema3 + atr * ATR_MULTIPLIER_ENTRY;
const shortEntryThreshold = ema3 - atr * ATR_MULTIPLIER_ENTRY;

console.log(`[LOGIC] bid=${bid} ask=${ask} ema3=${ema3} atr=${atr}`);
